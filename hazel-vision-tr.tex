...
% Author macros::begin %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Designing an Interactive Programming Environment from First Principles
%\footnote{This work was partially supported by someone.}
}
\titlerunning{Designing an Interactive Programming Environment from First Principles} %optional, in case that the title is too long; the running title should fit into the top page column
...
\affil[7]{University of Colorado Boulder\\
...
\Copyright{Cyrus Omar, MO}%mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
