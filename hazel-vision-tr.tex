...
inconsistencies, but no binding inconsistencies. The results are detailed in our work Omar et al.~\cite{popl-paper}. Figure~\ref{fig:hexp-syntax} defines the syntactic
