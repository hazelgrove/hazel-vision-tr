...
% our encoding uses the \emph{zipper} pattern~\citep{huet}, discussed
...
Section~\ref{sec:statics}. Portions of this work is scheduled to appear in our forthcoming POPL paper~\citep{popl-paper}. Figure \ref{fig:zexp-syntax} defines the syntax
...
\citep{JFP::Huet1997} (which, coincidentally, Huet encountered while implementing
a structure editor).
